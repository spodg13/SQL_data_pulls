queries = {
    "eDiscovery": """
        ...
        SELECT a.ACCESS_INSTANT
            ...
            ,a.PAT_ID
        INTO #tmpAcc
        FROM clarity_rpt.dbo.ACCESS_LOG AS a
        ...
        AS (
            SELECT ACCESS_TIME
                ...
                ,a.PAT_ID
            FROM #tmpAcc a
            LEFT JOIN clarity_rpt..ACC_LOG_DTL_IX v
        ...
        AS (
            SELECT ACCESS_TIME
                ...
                ,a.PAT_ID
            FROM #tmpAcc a
            LEFT JOIN CLARITY_RPT..ACC_LOG_MTLDTL_IX W
...
# ----------------------------
    "cyber_patientless": """
        ...
        with CTE_WRKF as (
            ...
            FROM clarity_rpt.dbo.ACCESS_WRKF a
        ...
        AS (
            ...
            FROM clarity_rpt.dbo.ACCESS_LOG AS d
